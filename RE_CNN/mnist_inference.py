...
def inference(input_tensor, train, regularizer):
    ...
    with tf.variable_scope('layer1-conv1'):
        ...
        conv1_biases = tf.get_variable("bias", [CONV1_DEEP], initializer=tf.constant_initializer(0.0),dtype=tf.float32)
    ...
    with tf.variable_scope('layer3-conv2'):
        ...
        conv2_biases = tf.get_variable("bias", [CONV2_DEEP], initializer=tf.constant_initializer(0.0),dtype=tf.float32)
